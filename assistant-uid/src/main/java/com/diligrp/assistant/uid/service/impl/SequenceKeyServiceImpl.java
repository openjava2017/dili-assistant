package com.diligrp.assistant.uid.service.impl;

import com.diligrp.assistant.shared.ErrorCode;
import com.diligrp.assistant.uid.dao.SequenceKeyDao;
...
public class SequenceKeyServiceImpl implements SequenceKeyService {
    ...
    public PersistentSequenceKey findSequenceKey(String key) {
        return sequenceKeyDao.findSequenceKey(key).orElseThrow(() ->
            new UidException(ErrorCode.OBJECT_NOT_FOUND, "没有配置该SequenceKey"));
    }
